...
function main()
	...
	sampAddChatMessage(tag .. main_color_text .. "Скрипт готов к работе Это обнова кста. Автор - " .. "{FFFFFF}" ..  "СоМиК" .. main_color_text .. "! Подробнее: клавиша " .. "{FFFFFF}" .. "HOME", main_color)
	active1 = false
	active2 = false
	imgui.Process = false
	theme = 1
